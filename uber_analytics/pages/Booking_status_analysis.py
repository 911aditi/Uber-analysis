...
st.markdown("<p style='color:brown; text-align: left; font-size:18px; font-weight:bold'>Heatmap between various columns: </p>", unsafe_allow_html=True)
df_corr = df_filtered[(df_filtered['Driver Ratings'] != 0) & (df_filtered['Customer Rating'] != 0)]
