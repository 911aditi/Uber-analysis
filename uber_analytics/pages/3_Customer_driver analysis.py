...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>Average VTAT over time: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>Average CTAT over time: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>Customer Cancellation Reasons: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>Driver Cancellation Reasons: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>Cancellation Share (Customer vs Driver): </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>Driver Ratings by Vehicle Type: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>Customer Ratings by Vehicle Type: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#4FC3F7; text-align: left; font-size:18px; font-weight:bold'>VTAT Distribution for Cancelled vs Completed Rides: </p>", unsafe_allow_html=True)
