...
st.markdown("<p style='color:#73C2FF; text-align: left; font-size:18px; font-weight:bold'>Bookings by Vehicle Type: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#73C2FF; text-align: left; font-size:18px; font-weight:bold'>Vehicle type vs Booking Status: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#73C2FF; text-align: left; font-size:18px; font-weight:bold'>Average ride distance by Vehicle Type: </p>", unsafe_allow_html=True)
...
st.markdown("<p style='color:#73C2FF; text-align: left; font-size:18px; font-weight:bold'>Booking Value by Vehicle Type: </p>", unsafe_allow_html=True)
